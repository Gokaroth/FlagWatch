...
class BeachSafetyApp {
    ...
    translations = {
        en: {
            ...
            "rip-title": "Rip currents",
            "ripNotice": "Rip currents (Bulgarian: мъртво течение, also обратно течение) form on this coast in water as calm as 0.3–0.6 m and cannot be detected by any model, including this one. A patch that looks calmer and flatter than the water either side of it is the classic warning sign, not a safe spot. A rip pulls you AWAY from shore, not under. If caught: do not swim against it, swim parallel to the beach until you are out of it.",
        ...
        bg: {
            ...
            "rip-title": "Мъртво течение",
            "ripNotice": "Мъртвото течение (обратно течение, „сулган“) се образува по нашето крайбрежие и при съвсем спокойно море, при вълни от 0,3 до 0,6 м, и не може да бъде засечено от никакъв модел, включително този. Участък, който изглежда по-спокоен и по-равен от водата около него, е класическият предупредителен знак, а не безопасно място. Течението Ви дърпа НАВЪТРЕ, а не надолу. Ако Ви хване: не плувайте срещу него, плувайте успоредно на брега, докато излезете от него.",
